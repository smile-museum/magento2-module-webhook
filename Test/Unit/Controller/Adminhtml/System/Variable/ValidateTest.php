...
namespace SweetTooth\Webhook\Test\Unit\Controller\Adminhtml\System\Variable;
...
{
    /**
     * @var \SweetTooth\Webhook\Model\Variable|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \SweetTooth\Webhook\Controller\Adminhtml\System\Variable\Validate | \PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->validateMock = $this->getMockBuilder('SweetTooth\Webhook\Controller\Adminhtml\System\Variable\Validate')
            ->disableOriginalConstructor()
            ->getMock();

        $this->variableMock = $this->getMockBuilder('SweetTooth\Webhook\Model\Variable')
            ->disableOriginalConstructor()
            ->getMock();
