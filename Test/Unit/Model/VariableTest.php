...
{
    /** @var  \SweetTooth\Webhook\Model\Variable */
    private $model;
    ...
    public function setUp()
    {
        ...
        $this->escaperMock = $this->getMockBuilder('Magento\Framework\Escaper')
            ...
            ->getMock();
        $this->resourceMock = $this->getMockBuilder('SweetTooth\Webhook\Model\Resource\Variable')
            ->disableOriginalConstructor()
            ->getMock();
        $this->model = $this->objectManager->getObject(
            'SweetTooth\Webhook\Model\Variable',
            [
    ...
    {
        $type = \SweetTooth\Webhook\Model\Variable::TYPE_HTML;
        $html = '<html/>';
    ...
    {
        $type = \SweetTooth\Webhook\Model\Variable::TYPE_TEXT;
        $plain = 'plain';
        $this->model->setData('plain_value', $plain);
    ...
    public function testGetVariablesOptionArrayNoGroup()
    {
        ...
        $collectionMock = $this->getMockBuilder('\SweetTooth\Webhook\Model\Resource\Variable\Collection')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $mockVariable = $this->getMock(
            'SweetTooth\Webhook\Model\Variable',
            ['getCollection'],
            $this->objectManager->getConstructArguments('SweetTooth\Webhook\Model\Variable')
        );
